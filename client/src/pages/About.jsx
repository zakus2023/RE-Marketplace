...
export default function About() {
  return (
    <div className="about">
      <h1>About Abdul Real Estate</h1>
      <div className="inner-about">
        <p>
          Abdul Real Estate is a leading real estate agency that specializes in
          ...
          to help you every step of the way. Our team of agents has a wealth of
